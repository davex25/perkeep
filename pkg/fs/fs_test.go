...
func TestRoot(t *testing.T) {
	...
	pkmountTest(t, func(env *mountEnv) {
		...
		sort.Strings(names)
		want := []string{"WELCOME.txt", "at", "date", "recent", "roots", "search", "sha1-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", "sha224-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", "tag", "versions"}
